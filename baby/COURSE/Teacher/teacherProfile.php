    ...
    <div class="container">
        <div class="row mt-4 mb-3">
          ...
          <div class="d-flex flex-row-reverse">
            <p>faculty of Economic management Science</p>
        </div>
        </div>
        </div>
    </div>
...
{
?>
        <h6 class="mt-4" style="margin-left: 4px;"> North West University | I Am <b> <?php echo $row['teacher_name'];?></b></h6>
<?php
}
?>
      </div>
...
?>
                                ...
                                <p>Department of Economic management Science</p>
