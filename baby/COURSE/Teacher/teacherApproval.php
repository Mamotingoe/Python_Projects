...
<div class="container" style="margin-left: 105px;">
  <div class="row">
    ...
    <img src="../img/NWU2.webp" style="height:50px">
<?php
$stmt = $connect->query("SELECT * FROM teachersignup WHERE email='".$_SESSION["emai"]."'");
$row = $stmt->fetch(PDO::FETCH_ASSOC);
{
?>
        <h6 class="mt-4" style="margin-left: 4px;"> North West University | I Am <?php echo $row['teacher_name'];?></h6>
<?php
}
?>
  </div>
...
?>
                                    ...
                                    <p>Department of EMS</p> 
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item text-center">
                              <a class="nav-link active" id="home-tab"  href="teacherApproval.php" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color: white ;width:10rem">Pending Requests</a>
                          </li>   
                          </ul>
                        </div>
                    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <span style="float: right; font-family: Palatino Linotype, Verdana; font-size: 11pt">
              <b>Session: </b> 2023 (Bcom.)<br><b>ExamTypes: </b> Regular, Recourse, Retake</span>
          </div>
...
<input type="text" class="form-control me-6  " id="search" type="search" placeholder="Search" aria-label="Search" style="background-color:pink;" onkeyup="search_data()">
</form> 
</div>
</div>
</div>
...
<footer class="text-center">
      <pre>
        <code>
          Copyright ©2022 NWU, All Rights Reserved.
