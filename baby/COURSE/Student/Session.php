...
<nav class="navbar navbar-expand-lg navbar-dark mb-3">
        <div class="container justify-content-around">
          <div class="col-md-10  col-sm-6 col-xs-6 px-5 pt-2 bg1" style=" background-color: purple">
...
?>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item text-center">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color:white; width:8rem">Enrollment</a>
                            </li>
                          <li class="nav-item text-center">
                              <a class="nav-link active" id="home-tab" data-toggle="tab" href="Session.php" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color:white; width:100%">Select Enrollment</a>
                          </li>
    ...
    <div class="row">  
      <div class="col-md-2 col-sm-2 offset-md-3 d-flex " style="margin-top: 52px;" >
        <td style=" height: 22px;">
          Select Available enrollment : </td>
      </div>
