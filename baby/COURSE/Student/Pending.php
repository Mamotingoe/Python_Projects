...
?>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                              ...
                              <li class="nav-item text-center">
                                  <a class="nav-link active" id="select-tab"  href="Session.php" role="tab" aria-controls="select" aria-selected="true" style=" background-color:purple;color: white; width:100$">Select enrollment</a>
                              </li>
                              <li class="nav-item text-center">
                                <a class="nav-link active" id="enroll-tab"  href="coursetable.php" role="tab" aria-controls="enroll" aria-selected="true" style=" background-color: purple;color: white; width:11rem">Select Courses & Enroll</a>
                            </li>
                            <li class="nav-item text-center">
                              <a class="nav-link active" id="pending-tab"  href="Pending.php" role="tab" aria-controls="pending" aria-selected="true" style=" background-color:purple;color: white; width:10rem">Pending Requests</a>
                          </li>
                          <li class="nav-item text-center">
                            <a class="nav-link active" id="approved-tab"  href="Approved.php" role="tab" aria-controls="approved" aria-selected="true" style=" background-color:purple;color: white; width:10rem">Approved Requests</a>
                        </li>   
                          </ul>
                        </div>
                    </div>
...
{
?>
                    <p>Student Number : <th><?php echo($row['roll_no'])?></th> </p>
<?php
}
?>
                    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <span style="float: right; font-family: Palatino Linotype, Verdana; font-size: 11pt">
              <b>enrollment: </b> 2023 (Bcom)<br><b>ExamTypes: </b> Regular, Recourse, Retake</span>
          </div>
    ...
    <section>
        ...
        <table class="table table-hover table-bordered text-center" style="background-color: pink;">
            <thead>
              <tr>
