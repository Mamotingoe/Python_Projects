...
<body>
    ...
    <div class="container" style="margin-left: 105px;">
      <div class="row">
        ...
        <img src="../img/NWU2.webp" style="height:80px">
          <?php
$stmt = $connect->query("SELECT * FROM studentsignup WHERE roll_no='".$_SESSION["roll_no"]."'");
$row = $stmt->fetch(PDO::FETCH_ASSOC);
{
?>
        <h6 class="mt-4" style="margin-left: 4px;"> North West  University | Welcome <b> <?php echo $row['student_name'];?></b></h6>
<?php
}
?>
      </div>
...
?>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item text-center mt-5">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color:white; width:7rem">Wall</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <!-- <div class="exclusive">
                      <strong>E X C L U S I V E &nbsp; P O W E R S</strong>
                        ...
                        <div class="list-group list-group-flush listhover fw-bold">
                            <a href="Session.php" class="list-group-item list-group-item-action licolor mt-1" style="height:30px;">REGISTRATION</a>
