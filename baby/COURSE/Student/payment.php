...
<nav class="navbar navbar-expand-lg navbar-dark mb-3">
        ...
        <div class=" container col-12 px-5 pt-2 bg" style=" background-color: purple">
          ...
          <li class="nav-item mx-2">
            <a class="nav-link text-white bordernav" href="success.php">Proof Of Payment</a>
          </li>
            </ul>
      <form class="d-flex">
        <ul class="navbar-nav  me-auto mb-2 mb-lg-0 navhover">
...
?>
                                ...
                                <p>Department of Economics and management science</p>
...
<section>
    ...
    <section>
        ...
        <table class="table table-hover table-bordered text-center" style="background-color: purple; color:white;">
            <thead>
              <tr>
...
?>
              <tr>
                ...
                <td>Tuition Fee: <?php echo $row['tuitionfee'] ?> + Exam Fee: <?php echo $row['examfee'] ?></td>
    ...
    <div class="container col-1">
        <div class="row justify-content-center">
            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                ...
                data-image="https://www.early-nutrition.org/fileadmin/_processed_/7/4/csm_NWU_logo4_e2a7da6dd6.png"
                data-locale="auto"
                data-currency="zar"> <!-- Specify currency as ZAR (South African Rand) -->
            </script>
        </div>
    </div>
</form>
...
<footer class="text-center">
      <pre>
        <code>
          Copyright ©2023 North West University, All Rights Reserved.
