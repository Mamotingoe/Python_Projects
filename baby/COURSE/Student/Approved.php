...
?>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                              ...
                              <li class="nav-item text-center">
                                  <a class="nav-link active" id="home-tab"  href="Session.php" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color: white; width:9rem">Select enrollment</a>
                              </li>
                              <li class="nav-item text-center">
...
{
?>
                    <p>Student : <th> <b> <?php echo($row['roll_no'])?> </b> </th> </p>
<?php
}
?>
                    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <span style="float: right; font-family: Palatino Linotype, Verdana; font-size: 11pt">
              <b>enrollment: </b> 23 (Bcom)<br><b>ExamTypes: </b> Regular, Recourse, Retake</span>
          </div>
...
<footer class="text-center">
      <pre>
        <code>
          Copyright ©2012 North West University, All Rights Reserved.
