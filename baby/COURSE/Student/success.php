...
{
?>
        <h6 class="mt-4" style="margin-left: 4px;"> North West University | I Am <?php echo $row['student_name'];?></h6>
<?php
}
?>
  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <span style="float: right; font-family: Palatino Linotype, Verdana; font-size: 11pt">
              <b>Enrollment: </b> 2022 (Bcom)<br><b>ExamTypes: </b> Regular, Recourse, Retake</span>
          </div>
