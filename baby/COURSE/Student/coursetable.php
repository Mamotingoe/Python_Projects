...
<div class="container" style="margin-left: 105px;">
  <div class="row">
    ...
    <img src="../img/NWU2.webp" style="height:40px">
<?php
$stmt = $connect->query("SELECT * FROM studentsignup WHERE roll_no='".$_SESSION["roll_no"]."'");
$row = $stmt->fetch(PDO::FETCH_ASSOC);
{
?>
        <h6 class="mt-4" style="margin-left: 4px;"> North West University | I Am <b> <?php echo $row['student_name'];?> </b> </h6>
<?php
}
?>
  </div>
...
<nav class="navbar navbar-expand-lg navbar-dark mb-3">
        ...
        <div class=" container col-12 px-5 pt-2 bg" style=" background-color: purple">
...
?>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item text-center">
                                <a class="nav-link active" id="home-tab"  href="#" role="tab" aria-controls="home" aria-selected="true" style=" background-color:purple;color:white; width:9rem">Enrollment</a>
                            </li>
                          <li class="nav-item text-center">
                              <a class="nav-link active" id="home-tab"  href="Session.php" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color:white; width:100%">Select Enrollment</a>
                          </li>
                          <li class="nav-item text-center">
                            <a class="nav-link active" id="home-tab"  href="coursetable.php" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color:white; width:11rem">Select Courses & Enroll</a>
                        </li>
                        <li class="nav-item text-center">
                          <a class="nav-link active" id="home-tab"  href="Pending.php" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color:white; width:10rem">Pending Requests</a>
                      </li>
                      <li class="nav-item text-center">
                        <a class="nav-link active" id="home-tab"  href="Approved.php" role="tab" aria-controls="home" aria-selected="true" style=" background-color: purple;color:white; width:10rem">Approved Requests</a>
                    </li>       
                      </ul>
                    </div>
                </div>
...
{
?>
                    <p>Student Number : <th><b><?php echo($row['roll_no'])?> </b> </th> </p>
<?php
}
?>
                </div>
                <div class="col-md-12" style="color:purple; border-top: 2px solid;"></div>         
            </div>         
    </div>  
</section>
...
?>
          <b>Session: </b> 2022 (BCOM)<br><b>ExamTypes: </b> Regular, Recourse, Retake</span>
      </div>
      <div class="col-md-12  my-3" style="color:purple; border-top: 2px solid;"></div>
    </div>
  </div>
</section>
...
<div class="container mt-3" >
    <div class="accordion mb-4" id="accordionExample" >
        <div class="accordion-item" style="background-color: pink">
          <h2 class="accordion-header" id="headingOne">
            <button class="accordion-button collapsed fw" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" style="background: #800080; color: white">
              1st Year
            </button>
          </h2>
...
<div class="accordion" id="accordionExample">
        ...
        <div class="accordion-item" style="background-color: pink">
          <h2 class="accordion-header" id="headingTwo">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="background: #800080;color: white">
              2nd Year
            </button>
          </h2>
    ...
    <div class="accordion" id="accordionExample">
        ...
        <div class="accordion-item" style="background-color: pink">
          <h2 class="accordion-header" id="headingThree">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="background: #800080;color: white">
              3rd Year
            </button>
          </h2>
    ...
    <div class="accordion" id="accordionExample">
      ...
      <div class="accordion-item" style="background-color: pink">
        <h2 class="accordion-header" id="headingFour">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour" style="background: #800080;color: white">
            4th year
          </button>
        </h2>
