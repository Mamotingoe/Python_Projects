    ...
    <div class="container">
        <div class="row mt-4 mb-3">
          ...
          <div class="d-flex flex-row-reverse">
            <p>For Faculty of Economic and management Science</p>
        </div>
        </div>
        </div>
    </div>
...
<section>
    <div class="container" style="margin-left: 105px;">
      <div class="row">
        ...
        <h6 class="mt-4" style="margin-left: 4px;"> <b> North WestUniversity | I Am Admin </b></h6>
      </div>
    </div>
    </div>
</section>
...
<footer class="text-center">
      <pre>
        <code>
          Copyright ©2013-2021 North West University, All Rights Reserved.
